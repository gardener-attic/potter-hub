...
describe("ResourceRef", () => {
  ...
  describe("getResourceURL", () => {
    ...
    it("calls Kube.getResourceURL with the correct arguments", () => {
      ...
      ref.getResourceURL();
      expect(kubeGetResourceURLMock).toBeCalledWith("v1", "services", false, "bar", "foo");
    });
  });
  ...
  describe("watchResourceURL", () => {
    ...
    it("calls Kube.watchResourceURL with the correct arguments", () => {
      ...
      expect(kubeWatchResourceURLMock).toBeCalledWith("v1", "services", false, "bar", "foo");
    });
  });
  ...
  describe("getResource", () => {
    ...
    it("calls Kube.getResource with the correct arguments", () => {
      ...
      ref.getResource();
      expect(kubeGetResourceMock).toBeCalledWith("v1", "services", false, "bar", "foo");
    });
  });
  ...
  describe("watchResource", () => {
    ...
    it("calls Kube.watchResource with the correct arguments", () => {
      ...
      ref.watchResource();
      expect(kubeWatchResourceMock).toBeCalledWith("v1", "services", false, "bar", "foo");
    });
  });
});
