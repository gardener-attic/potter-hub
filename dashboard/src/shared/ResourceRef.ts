...
class ResourceRef {
  ...
  public isOnResourceCluster: boolean;
  ...
  // class.
  constructor(r: IResource, defaultNamespace?: string, isOnResourceCluster?: boolean) {
    ...
    isOnResourceCluster
      ? (this.isOnResourceCluster = isOnResourceCluster)
      : (this.isOnResourceCluster = false);
    return this;
  }
