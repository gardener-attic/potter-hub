...
function mapStateToProps({ charts, namespace, config: { urlParams } }: IStoreState, { match: { params } }: IRouteProps) {
  return {
    ...
    targetClusterSecretNamespace: urlParams.targetClusterSecretNamespace,
    targetClusterSecretName: urlParams.targetClusterSecretName
  };
}
