...
describe("filterByResourceRefs", () => {
  ...
  const items: IKubeState["items"] = {
    "api/ui-backend/reverse-proxy/v1/api/v1/namespaces/foo/services/bar": {
      item: svc1,
    } as IKubeItem<IResource>,
    "api/ui-backend/reverse-proxy/v1/api/v1/namespaces/foo1/services/bar": {
      item: svc2,
    } as IKubeItem<IResource>,
    "api/ui-backend/reverse-proxy/v1/apis/apps/v1/namespaces/foo1/deployments/bar": {
      item: deploy,
    } as IKubeItem<IResource>,
  };
