...
describe("AccessURLTableContainer", () => {
  it("maps Services and Ingresses in store to AccessURLTable props", () => {
    ...
    const store = makeStore({
      "api/ui-backend/reverse-proxy/v1/api/v1/namespaces/wee/services/foo-service": service,
      "api/ui-backend/reverse-proxy/v1/api/v1/namespaces/wee/ingresses/foo-ingress": ingress,
    });
