...
const versions = [{ id: "foo", attributes: { version: "1.2.3", app_version: "4.5.6" } }] as IChartVersion[];
...
it("marks the current version", () => {
  ...
  expect(wrapper.find("select").text()).toMatch("Chart: 1.2.3 | App: 4.5.6 (current)");
});
